...
/*   Updated: 2025/08/20 16:39:30 by tomasklaus       ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_table fill_params(char **argv){
    ...
    table.die_time = (time_t)ft_safe_atoi(argv[2], &error)*1000;
    table.eat_time = (time_t)ft_safe_atoi(argv[3], &error)*1000;
    table.sleep_time = (time_t)ft_safe_atoi(argv[4], &error)*1000;
    if (argv[5])
